                            ...
                            <div class="col-md-9 register-right">
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                                        ...
                                        <h1 class="register-heading">AGREGAR PRODUCTO</h1>
                                                ...
                                                <form id="form_proveedores" style="width: 450px;"
                                                    ...
                                                    <div style="display: none" class="form-group">
                                                        ...
                                                        <input
                                                            ...
                                                            name="costo_compra"
                                                            id="costo_compra" type="number" min="0" required
                                                            placeholder="Ingrese el costo compra"
                                                            maxlength="80" value="0">
                                                        @error('costo_compra')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    ...
                                                    <div style="display: none" class="form-group">
                                                        ...
                                                        <input
                                                            ...
                                                            name="costo_venta"
                                                            id="costo_venta" type="number" min="0" required
                                                            placeholder="Ingrese el costo venta"
                                                            maxlength="80" value="0">
                                                        @error('costo_venta')
                                                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                                        ...
                                        <div class="row register-form">
                                            <div class="col-md-6">
                                                ...
                                                <form id="form_proveedores" style="    width: 450px;"
                                                      enctype="multipart/form-data" action="{{route("proveedor.stor")}}"
                                                      method="post">
                                                    @csrf
                                                    <div class="form-group">
