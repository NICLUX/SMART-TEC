                            ...
                            <form id="form_proveedores" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control  @error('nombre') is-invalid @enderror" type="text"
                                        pattern="[A-Za-z ]{2,20}" required maxlength="20" @if(old("nombre"))
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('descripcion') is-invalid @enderror"
                                        maxlength="40" name="descripcion">@if(old("descripcion")){{old("descripcion")}}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('direccion') is-invalid @enderror" required
                                        maxlength="40" name="direccion">@if(old("direccion")){{old("direccion")}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" type="email"
                                        @if(old("email")) value="{{old("email")}}" @else value="{{$proveedor->email}}"
