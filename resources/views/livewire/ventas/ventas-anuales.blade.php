<div>
    <div xmlns:wire="http://www.w3.org/1999/xhtml">
        <div class="card">
            <div class="list-group-item active">
                <div class="form-group float-left center-block" style="width: 300px">
                    <h1>Ingresos del año <strong>{{$anio}}</strong> </h1>
                </div>
            ...
            <div class="card-body">
                <div class="container">
                    <div class="row">
                        <div class="col-sm">
                            <h3 wire:model="total_ingreso_del_anio">Ingresos: <span
                                    class="badge badge-success">L. {{$total_ingreso_del_anio}}</span></h3>
                        </div>
                        <div class="col-sm">
                            <h3>Costo de venta: <span class="badge badge-danger">L. {{$total_costo_del_anio}}</span>
                            </h3>
                        </div>
                        <div class="col-sm">
                            <h3>Margen de ganancia: <span
                                    class="badge {{ (isset($total_ganacia_del_anio)?$total_ganacia_del_anio:-1<0)?'badge-success':'badge-danger'}}">L. {{$total_ganacia_del_anio}}</span>
                            </h3>
                        </div>
                    </div>
                    <br>
        ...
        <div class="card">
            <div class="list-group-item active">
                <h1>Ingresos mensuales del año <strong>{{$anio}}</strong></h1>
            </div>
            <div class="card-body">
                <div class="container">
                    <div class="row">
