        ...
        <div class="card-body">
            <form>
                            ...
                            <select class="form-control @error("id_producto") is-invalid @endError"
                                ...
                                @foreach($productos as$producto)
                                    <option value="{{$producto->id}}">{{$producto->nombre}}
                                        ...
                                        Lps. {{$producto->costo_venta}} || Stock: {{$producto->en_stock}}</option>
                                @endforeach
                            </select>
                            <div class="input-group-prepend">
                                ...
                                <button class="btn btn-sm btn-dark"
                                        wire:click.prevent="agregarProducto()"><i class="fa fa-arrow-right"></i> Agregar
                                    Producto
                                </button>
                                @error("cantidad")
                ...
                <div class="btn btn-success"
                     wire:click.prevent="guardarVenta()"
                     type="submit"><i class="fa fa-save"></i> Finalizar venta
                </div>
            </form>
        </div>
        <br>
                ...
                <div class="card-columns">
                    @foreach($productos_en_cola as $detalle)
                        <div class="card" style="height: 150px">
                            <img src="/images/productos/{{$detalle->producto->imagen_url}}"
                                 class="card-img-top"
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><i
                                        class="fa fa-codepen"></i> {{$detalle->producto->nombre_categoria}}</p>
