...
Route::get("/serviciosTabla",[\App\Http\Controllers\ServicioController::class,"nuevaVista"])->name("servicios.nuevaVista");//muestra todos los servicios
...
Route::get("/servicios/busqueda",[\App\Http\Controllers\ServicioController::class, "buscarServicio"])->name("servicios.buscar");//Buscar Servicio
